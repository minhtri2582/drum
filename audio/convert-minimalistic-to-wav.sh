#!/bin/bash
# Convert MP3 trong audio/minimalistic/ sang WAV với tên chuẩn
# Nguồn: https://www.musicca.com/files/audio/tools/drums/minimalistic
# Chuẩn đặt tên (khớp SAMPLE_KEYS trong app.js)

set -e
cd "$(dirname "$0")/minimalistic"
...
# Mapping: file nguồn musicca minimalistic -> tên chuẩn
...
echo "Done. Cowbell not in musicca minimalistic set - app will use synthesis fallback."
