#!/bin/bash
# Convert MP3 trong audio/energetic/ sang WAV với tên chuẩn
# Nguồn: https://www.musicca.com/files/audio/tools/drums/energetic
# Chuẩn đặt tên (khớp SAMPLE_KEYS trong app.js)

set -e
cd "$(dirname "$0")/energetic"
...
# Mapping: file nguồn musicca energetic -> tên chuẩn
...
echo "Done. Cowbell not in musicca energetic set - app will use synthesis fallback."
