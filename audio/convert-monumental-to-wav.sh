#!/bin/bash
# Convert MP3 trong audio/monumental/ sang WAV với tên chuẩn
# Nguồn: https://www.musicca.com/files/audio/tools/drums/monumental
# Chuẩn đặt tên (khớp SAMPLE_KEYS trong app.js)

set -e
cd "$(dirname "$0")/monumental"
...
# Mapping: file nguồn musicca monumental -> tên chuẩn
...
echo "Done. Cowbell not in musicca monumental set - app will use synthesis fallback."
